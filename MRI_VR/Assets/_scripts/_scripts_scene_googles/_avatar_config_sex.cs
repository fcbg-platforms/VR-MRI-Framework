...
public class _avatar_config_sex : MonoBehaviour
{
    private GameObject _Character_Child_Male;
    private GameObject _Character_Child_Female;
    private GameObject _Character_Child_Box;

    [HideInInspector]
    public string s_last_avatar_sex_before_none = "";
    ...
    public void SetMaleSex()
    {
        ...
        _Character_Child_Box.SetActive(false);

        s_last_avatar_sex_before_none = "male";
    }
    ...
    public void SetFemaleSex()
    {
        ...
        s_last_avatar_sex_before_none = "female";
    }

    void InitialiseReferences()
    {
        _Character_Child_Male = _class_all_references_scene_mri_compatible_googles.Instance.GO_Character.transform.GetChild(0).gameObject;
        _Character_Child_Female = _class_all_references_scene_mri_compatible_googles.Instance.GO_Character.transform.GetChild(1).gameObject;
        _Character_Child_Box = _class_all_references_scene_mri_compatible_googles.Instance.GO_Character.transform.GetChild(2).gameObject;
        _Character_Child_Box.SetActive(false);
    }
    ...
    {
        SetNoSkin();
        _Character_Child_Box.SetActive(true);
        
        s_last_avatar_sex_before_none = "box";
    }
}
